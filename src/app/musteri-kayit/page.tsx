...
export default function MusteriKayitPage() {
  ...
  const onSubmit = async (data: SignupFormValues) => {
    ...
    try {
      ...
      toast.success("Müşteri kaydınız başarıyla oluşturuldu! Giriş sayfasına yönlendiriliyorsunuz.");
    ...
    <div className="flex min-h-screen">
        ...
        <div className="h-full w-full flex items-center justify-center p-12">
          <div className="max-w-xl text-white">
            ...
            <p className="text-lg opacity-90 mb-8">
              Müşteri hesabınızla tüm ev hizmetlerine kolayca ulaşabilir, teklifler alabilir ve güvenilir ustalarla çalışabilirsiniz.
            </p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-5 sm:px-10 lg:px-20 py-16">
        <div className="max-w-md w-full mx-auto">
          <h1 className="text-3xl font-bold mb-6">Müşteri Hesabı Oluştur</h1>
          <p className="text-gray-600 mb-8">
            Hemen ücretsiz üye olun ve tüm hizmetlerimizden yararlanmaya başlayın.
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            >
              {isLoading ? "Kayıt Yapılıyor..." : "Müşteri Hesabı Oluştur"}
            </button>
          </form>
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-sm text-gray-600 mt-6 pt-6 border-t border-gray-200">
              Usta olarak kayıt olmak ister misiniz?{" "}
